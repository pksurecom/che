...
public class MarkDirAsSourceActionTest {
    ...
    @Mock
    private Promise<List<ClasspathEntry>> classpathPromise;
    @Mock
    private PromiseError                  promiseError;

    @Captor
    private ArgumentCaptor<Operation<List<ClasspathEntry>>> classpathCapture;
    @Captor
    ...
    public void setUp() throws Exception {
        ...
        when(classpathPromise.then(Matchers.<Operation<List<ClasspathEntry>>>anyObject())).thenReturn(classpathPromise);
    }
    ...
    public void readingClasspathFailed() throws Exception {
        ...
        verify(notificationManager).notify("Can't get classpath", TEXT, FAIL, true);
    }
