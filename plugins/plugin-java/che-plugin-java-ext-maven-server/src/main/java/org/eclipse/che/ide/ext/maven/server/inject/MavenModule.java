 ...
 *******************************************************************************/
package org.eclipse.che.ide.ext.maven.server.inject;
...
import org.eclipse.che.ide.ext.maven.server.core.MavenClassPathBuilder;
import org.eclipse.che.ide.ext.maven.server.projecttype.MavenProjectType;
import org.eclipse.che.ide.ext.maven.server.projecttype.handler.GeneratorStrategy;
import org.eclipse.che.ide.ext.maven.server.projecttype.handler.MavenProjectGenerator;
import org.eclipse.che.ide.ext.maven.server.projecttype.handler.ProjectBecomeMavenHandler;
import org.eclipse.che.ide.ext.maven.server.projecttype.MavenValueProviderFactory;
import org.eclipse.che.ide.ext.maven.server.projecttype.handler.ArchetypeGenerationStrategy;
