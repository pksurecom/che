 ...
 *******************************************************************************/
package org.eclipse.che.ide.ext.maven.client.inject;
...
import org.eclipse.che.ide.ext.maven.client.command.MavenCommandType;
import org.eclipse.che.ide.ext.maven.client.project.MavenContentRootInterceptor;
import org.eclipse.che.ide.ext.maven.client.project.MavenExternalLibrariesInterceptor;
import org.eclipse.che.ide.ext.maven.client.project.PomNodeInterceptor;
import org.eclipse.che.ide.ext.maven.client.wizard.MavenProjectWizardRegistrar;
