 ...
 *******************************************************************************/
package org.eclipse.che.ide.ext.maven.client.actions;
...
public class UpdateDependencyAction extends AbstractPerspectiveAction {
    ...
    public void updateInPerspective(@NotNull ActionEvent event) {
        event.getPresentation().setEnabledAndVisible(
                appContext.getCurrentProject() != null && MAVEN_ID.equals(appContext.getCurrentProject().getProjectConfig().getType()));
    }
}
