 ...
 *******************************************************************************/
package org.eclipse.che.ide.ext.maven.client.wizard;
...
import org.eclipse.che.ide.ext.maven.client.MavenExtension;
import org.eclipse.che.ide.ext.maven.client.MavenArchetype;
...
import static org.eclipse.che.ide.ext.maven.shared.MavenAttributes.ARTIFACT_ID;
import static org.eclipse.che.ide.ext.maven.shared.MavenAttributes.DEFAULT_PACKAGING;
import static org.eclipse.che.ide.ext.maven.shared.MavenAttributes.DEFAULT_SOURCE_FOLDER;
import static org.eclipse.che.ide.ext.maven.shared.MavenAttributes.DEFAULT_TEST_SOURCE_FOLDER;
import static org.eclipse.che.ide.ext.maven.shared.MavenAttributes.DEFAULT_VERSION;
import static org.eclipse.che.ide.ext.maven.shared.MavenAttributes.GROUP_ID;
import static org.eclipse.che.ide.ext.maven.shared.MavenAttributes.MAVEN_ID;
import static org.eclipse.che.ide.ext.maven.shared.MavenAttributes.PACKAGING;
import static org.eclipse.che.ide.ext.maven.shared.MavenAttributes.PARENT_GROUP_ID;
import static org.eclipse.che.ide.ext.maven.shared.MavenAttributes.PARENT_VERSION;
import static org.eclipse.che.ide.ext.maven.shared.MavenAttributes.SOURCE_FOLDER;
import static org.eclipse.che.ide.ext.maven.shared.MavenAttributes.TEST_SOURCE_FOLDER;
import static org.eclipse.che.ide.ext.maven.shared.MavenAttributes.VERSION;
...
public class MavenPagePresenter extends AbstractWizardPage<ProjectConfigDto> implements MavenPageView.ActionDelegate {
    ...
    public void go(AcceptsOneWidget container) {
        ...
        if (ProjectWizardMode.CREATE == wizardMode && projectName != null) {
