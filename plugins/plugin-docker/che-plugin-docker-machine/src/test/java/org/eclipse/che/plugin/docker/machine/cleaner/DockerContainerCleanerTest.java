...
public class DockerContainerCleanerTest {
    ...
    public void setUp() throws MachineException, IOException {
        ...
        when(dockerConnector.getContainers(eq(true),
                                           eq(0),
                                           eq(null),
                                           eq(null),
                                           eq(false),
                                           any())).thenReturn(new ContainerFromList[] {container1, container2});
    ...
    public void dockerContainerShouldBeKilledAndRemoved() throws MachineException, IOException {
        ...
        verify(dockerConnector).getContainers(eq(true), eq(0), eq(null), eq(null), eq(false), any());
